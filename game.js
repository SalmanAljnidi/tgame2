...
(() => {
  ...
  // منع قائمة الضغط المطوّل/الزر الأيمن (خصوصاً على iOS)
  window.addEventListener('contextmenu', (e)=> e.preventDefault(), {passive:false});

  // iOS أحياناً لا يلتقط PointerEvents بشكل مثالي للّمس السريع، لذلك نضيف TouchEvents مع preventDefault
  ...
  window.addEventListener('touchcancel',(e)=> { e.preventDefault(); endHold(); }, {passive:false});
